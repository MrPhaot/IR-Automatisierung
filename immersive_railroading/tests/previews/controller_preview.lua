...
assert(PROFILES.conservative.terminal_recovery_max_longitudinal_m == PROFILES.fast.terminal_recovery_max_longitudinal_m, "fast profile should now match conservative terminal recovery window (aligned endgame safety)")
...
do
  ...
  assert(is_terminal_success_physical_ok(fast_profile, 3.1, 3.0) == true, "fast terminal success should match conservative with same parameters (aligned endgame)")
