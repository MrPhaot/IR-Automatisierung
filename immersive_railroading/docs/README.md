...
- `control-model.md`: speed control, brake learning, and stop-envelope design
...
- `plans/curve-handling-v1/HANDOFF.md`: a later handoff focused on route geometry once the straight-line cleanup work is settled
